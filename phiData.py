...
def Phi_ParRubXu16_Measured():
    ## Table 2 of ParRubXu16
    ...
    Phi = {}
    consts =  thermoConstants()
    F = consts['F']
    for key in Gibbs.keys():
        Phi[key] = -Gibbs[key]*1e3/F
